...
int main() {
    ...
    info *p_orig[MAX_STOP], *p_ord_data[MAX_STOP],*p_ord_cod[MAX_STOP],*p_ord_part[MAX_STOP],*p_ord_dest[MAX_STOP];

    leggiLog(fermate, &numero_log);

    collega_log(fermate, p_orig, numero_log);
    collega_log(fermate, p_ord_cod, numero_log);
    collega_log(fermate, p_ord_data, numero_log);
    collega_log(fermate, p_ord_part, numero_log);
    collega_log(fermate, p_ord_dest, numero_log);
    ...
    do {
        ...
        menuComando(p_orig ,p_ord_cod, p_ord_data, p_ord_part, p_ord_dest, comando_N, numero_log);
...
void menuComando(info **ptr, info **p_ord_cod, info **p_ord_data, info **p_ord_part, info **p_ord_dest, comando_e comando, int numero_log) {
    ...
    switch (comando) {
        case stampa_log:
            ...
            break;
        case ord_data:
            f_stampa_log(p_ord_data);
            break;
        case ord_codice:
            f_stampa_log(p_ord_cod);
            break;
        case ord_part:
            f_stampa_log(p_ord_part);
            break;
        case ord_arr:
            f_stampa_log(p_ord_dest);
            break;
        case ric_part:
